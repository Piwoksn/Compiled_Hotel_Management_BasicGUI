...
#login Var
bgcolor1 = 'cornsilk2'
logo1 = PhotoImage(file='plain_logo.png')
icon1 = PhotoImage('venus_icon.ico')

#Register Var
bgcolor2 = 'cornsilk2'
logo2 = PhotoImage(file='plain_logo.png')
icon2 = PhotoImage('venus_icon.ico')
...
#forget Password Var
bgcolor4 = 'cornsilk2'
logo4 = PhotoImage(file='plain_logo.png')
icon4 = PhotoImage('venus_icon.ico')
...
menuColor6 ='white'
logo6 = PhotoImage(file='200by100.png')
icon6 = PhotoImage('venus_icon.ico')
dashboard_icon6 = PhotoImage(file='dashbd.png')
sub6 = PhotoImage(file='sub.png')
setting6 = PhotoImage(file='setting.png')
acct6 = PhotoImage(file='money.png')
bar6 = PhotoImage(file='drink.png')
gym6 = PhotoImage(file='gym.png')
hr6 = PhotoImage(file='hr.png')
bed6 = PhotoImage(file='bed.png')
spoon6 = PhotoImage(file='spoon.png')
store6 = PhotoImage(file='store.png')
round6 = PhotoImage(file='dot.png')
plus6 = PhotoImage(file='plus.png')
...
def login():
    ...
    def info():
        ...
        mainNavLabel6 = Label(menuFrame6, text='MAIN NAVIGATION', bg=menuColor6, fg='gray', font=('arial', 12,),
                              width=25)
        mainNavLabel6.grid(row=1, column=0, sticky='w', pady=10)

        def infodashbd():
            logoutButton6.destroy()
            taxesButton6.destroy()
            propertyInformationButton6.destroy()
            settingLabel6.destroy()
            newsubButton6.destroy()
            subButton6.destroy()
            acctLabel6.destroy()
            dashboardButton6.destroy()
            mainNavLabel6.destroy()
            logoLabel6.destroy()
            menuFrame6.destroy()
            itemsFrame6.destroy()
            taxLabel6.destroy()
            addressLabel6.destroy()
            addressEntry6.destroy()
            phoneLabel6.destroy()
            phoneEntry6.destroy()
            websiteLabel6.destroy()
            websiteEntry6.destroy()
            savebutton6.destroy()
            home()
    ...
    def tax():
        ...
        mainNavLabel5 = Label(menuFrame5, text='MAIN NAVIGATION', bg=menuColor5, fg='gray', font=('arial', 12,),
                              width=25)
        mainNavLabel5.grid(row=1, column=0, sticky='w', pady=10)

        def backtodash():
            logoutButton5.destroy()
            taxesButton5.destroy()
            propertyInformationButton5.destroy()
            settingLabel5.destroy()
            newsubButton5.destroy()
            subButton5.destroy()
            acctLabel5.destroy()
            dashboardButton5.destroy()
            mainNavLabel5.destroy()
            logoLabel5.destroy()
            menuFrame5.destroy()
            itemsFrame3.destroy()
            taxLabel5.destroy()
            alltaxLabel5.destroy()
            scrollbar5.destroy()
            alltaxList5.destroy()
            addtaxLabel5.destroy()
            taxnameLabel5.destroy()
            addtaxEntry5.destroy()
            ratetaxEntry5.destroy()
            ratenameLabel5.destroy()
            addbutton5.destroy()
            deletebutton5.destroy()
